...
<div class="container">
    ...
    <section class="card mb-4 rounded-3 shadow-sm">
        ...
        //Allows to retrieve in the url the month, else if url haven't got month, put the month acutally on variable
                    if (isset($_GET['month'])) {
        ...
        <td class="text-end">
                ...
                ' ?> <?php
                //get condition if the transaction if positive or negative
        ...
        <a  href="edit.php?id_transaction=' . $sold['id_transaction'] . '&token=' . $_SESSION['token'] . ' &name=' . $sold['name'] . ' &date=' . $sold['date_transaction'] . 'categorie=' . $sold['category_name'] . '&amount=' . $sold['amount'] . ' " class="btn btn-outline-primary btn-sm rounded-circle" data-id="' . $sold['id_transaction'] . '">
                ...
                <i class="bi bi-trash"></i>
                    ...
                    //Get on variable for add 1 month on date today or decrease 1 mont on date today   
                ...
                <ul class="pagination d-flex justify-content-center m-2">
                    <li class="page-item disabled">
                        <span class="page-link">
                            <?= ' <a href="index.php?month=' . $nextMonth . '"&token=' . $_SESSION['token'] . ' ><i class="bi bi-arrow-left"></i></a>' ?>
                        </span>
                    </li>
                    ...
                    <li class="page-item">
                        <?= ' <a href="index.php?month=' . $previousMonth . '"&token=' . $_SESSION['token'] . ' class="page-link">Juin 2023</a> ' ?>
                    </li>
                    <li class="page-item">
